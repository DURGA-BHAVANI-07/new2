  ...
  var cdInterval = setInterval(function () {
    ...
    if (dif <= 0) {
      ...
      elements.cd.insertAdjacentHTML(
        "beforeend",
        '<div class="celebrate"> Enjoy the celebration My Heart ❤! and I hope your all dreams comes true in this year Once again happy new year 😊(/div)'
    ...
    elements.cd_days.nextElementSibling.innerHTML =
      "Day" + (days == 1 ? "" : "s");
    elements.cd_hours.innerHTML = ("00" + hours).slice(-2);
    elements.cd_hours.nextElementSibling.innerHTML =
      "Hour" + (hours == 1 ? "" : "s");
    elements.cd_mins.innerHTML = ("00" + mins).slice(-2);
    elements.cd_mins.nextElementSibling.innerHTML =
      "Minute" + (mins == 1 ? "" : "s");
    elements.cd_secs.innerHTML = ("00" + secs).slice(-2);
    elements.cd_secs.nextElementSibling.innerHTML =
      "Second" + (secs == 1 ? "" : "s");
  }, 1000);
